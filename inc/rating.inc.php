...
class Rating{
	...
	public function addrating($q1, $q2, $q3, $q4, $q5, $overall, $comment, $email, $media) {
	        $stmt= $this->db->prepare("INSERT INTO rating (q1, q2, q3, q4, q5, overall, email, comment, date, media) values (:q1, :q2, :q3, :q4, :q5, :overall, :email, :comment, now(), :media)");
